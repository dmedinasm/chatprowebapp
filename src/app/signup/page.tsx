        ...
        <article className='md:w-1/2 border-l-2 border-stroke dark:border-strokedark  lg:px-44'>
            <div className=' p-4  lg:py-17.5'>
                ...
                <form action="">
                    ...
                    <div className='mb-5'>
                        <input type='submit' value='Create account' className='w-full cursor-pointer border border-chatprimary bg-chatprimary text-white p-2.5 rounded-lg transition hover:bg-opacity-90' />
                    </div>
                    <div>
